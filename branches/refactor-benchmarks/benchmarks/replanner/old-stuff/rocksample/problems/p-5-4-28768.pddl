...
(define (problem problem-5-5-28768)
    (:domain RockSample)
    (:objects
    ...
    (:init
        ...
        (invariant (not (good-rocks-in-range p4-2 h1)) (good r0) (good r1) (good r2))
        ...
        (invariant (not (good-rocks-in-range p4-3 h2)) (good r0) (good r1) (good r2) (good r4))
