...
(define (problem problem-5-5-10495)
    (:domain RockSample)
    (:objects
    ...
    (:init
        ...
        (invariant (not (good-rocks-in-range p1-1 h1)) (good r2) (good r3) (good r4))
        ...
        (invariant (not (good-rocks-in-range p2-1 h1)) (good r3) (good r4))
