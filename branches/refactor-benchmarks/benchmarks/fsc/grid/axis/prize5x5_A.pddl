(define (problem prize5x5)
  (:domain grid-A)
  (:objects x1 x2 x3 x4 x5 - xpos y1 y2 y3 y4 y5 - ypos)
  (:init
    (suc-x x1 x2) (suc-x x2 x3) (suc-x x3 x4) (suc-x x4 x5)
    (suc-y y1 y2) (suc-y y2 y3) (suc-y y3 y4) (suc-y y4 y5)
    (top-row y5) (bottom-row y1) (leftmost-col x1) (rightmost-col x5)
    ...
    (oneof (prize x1 y1) (prize x2 y1) (prize x3 y1) (prize x4 y1) (prize x5 y1)
           ...
           (prize x1 y4) (prize x2 y4) (prize x3 y4) (prize x4 y4) (prize x5 y4)
           (prize x1 y5) (prize x2 y5) (prize x3 y5) (prize x4 y5) (prize x5 y5)
    )
  )
  (:goal (got-it))
)
