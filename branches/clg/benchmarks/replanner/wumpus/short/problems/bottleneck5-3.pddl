...
(define (problem bottleneck5)
    ...
    (:hidden
       (wumpus p13) (stench p14) (stench p23) (stench p12)
       (wumpus p22) (stench p23) (stench p21) (stench p12)
       (wumpus p26) (stench p27) (stench p25) (stench p16)
       (wumpus p28) (stench p38) (stench p27) (stench p18)
       (wumpus p48) (stench p58) (stench p38)
       (wumpus p68) (stench p78) (stench p58)
       (wumpus p81) (stench p91) (stench p71)
       (wumpus p97) (stench p98) (stench p107) (stench p96)
       (wumpus p101) (stench p102) (stench p91)
       (wumpus p102) (stench p103) (stench p101) (stench p92)
    )
    (:goal (at p43))
)
