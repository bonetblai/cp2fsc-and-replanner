...
(define (problem dia10x10)
    ...
    (:hidden
       ...
       (wumpus p85) (stench p86) (stench p95) (stench p84) (stench p75)
       (wumpus p86) (stench p87) (stench p96) (stench p85) (stench p76)
       (wumpus p87) (stench p97) (stench p86)
       (wumpus p89) (stench p99) (stench p79)
       (wumpus p90) (stench p91) (stench p80)
       (wumpus p93) (stench p94) (stench p92) (stench p83)
    )
    (:goal (at p26))
)
