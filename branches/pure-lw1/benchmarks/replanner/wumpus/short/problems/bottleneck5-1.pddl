...
(define (problem bottleneck5)
    ...
    (:hidden
       (wumpus p45) (stench p46) (stench p55) (stench p44)
       ...
       (wumpus p91) (stench p92) (stench p101) (stench p81)
       (wumpus p95) (stench p96) (stench p105) (stench p94)
       (wumpus p98) (stench p108) (stench p97) (stench p88)
       (wumpus p102) (stench p103) (stench p101) (stench p92)
       (wumpus p103) (stench p104) (stench p102) (stench p93)
    )
    (:goal (at p24))
)
