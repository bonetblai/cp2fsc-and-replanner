...
(define (problem problem-5-5-24530)
    (:domain RockSample)
    (:objects
    ...
    (:init
        ...
        (invariant (not (good-rocks-in-range p0-4 h2)) (good r0) (good r2) (good r3))
        ...
        (invariant (not (good-rocks-in-range p1-4 h1)) (good r0) (good r2) (good r3))
