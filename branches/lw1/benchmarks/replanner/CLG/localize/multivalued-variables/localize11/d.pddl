(define (domain sliding-doors) 
    ...
    (:default-sensing-model
        (and (when (at p2-1) (and (free-left) (free-right) (not (free-up)) (not (free-down))))
             ...
             (when (at p11-2) (and (free-up) (free-down) (not (free-left)) (not (free-right))))
             (when (at p1-3) (and (free-up) (free-right) (free-down) (not (free-left))))
             (when (at p11-3) (and (free-up) (free-left) (free-down) (not (free-right))))
             (when (at p1-4) (and (free-up) (free-down) (not (free-left)) (not (free-right))))
             (when (at p11-4) (and (free-up) (free-down) (not (free-left)) (not (free-right))))
             (when (at p1-5) (and (free-up) (free-right) (free-down) (not (free-left))))
             (when (at p11-5) (and (free-up) (free-left) (free-down) (not (free-right))))
             (when (at p1-6) (and (free-up) (free-down) (not (free-left)) (not (free-right))))
             (when (at p11-6) (and (free-up) (free-down) (not (free-left)) (not (free-right))))
             (when (at p1-7) (and (free-up) (free-right) (free-down) (not (free-left))))
             (when (at p11-7) (and (free-up) (free-left) (free-down) (not (free-right))))
             (when (at p1-8) (and (free-up) (free-down) (not (free-left)) (not (free-right))))
             (when (at p11-8) (and (free-up) (free-down) (not (free-left)) (not (free-right))))
             (when (at p1-9) (and (free-up) (free-right) (free-down) (not (free-left))))
             (when (at p11-9) (and (free-up) (free-left) (free-down) (not (free-right))))
             (when (at p1-10) (and (free-up) (free-down) (not (free-left)) (not (free-right))))
             (when (at p11-10) (and (free-up) (free-down) (not (free-left)) (not (free-right))))
             (when (at p1-1) (and (free-up) (free-right) (not (free-down)) (not (free-left))))
             (when (at p11-1) (and (free-up) (free-left) (not (free-down)) (not (free-right))))
             (when (at p1-11) (and (free-down) (free-right) (not (free-up)) (not (free-left))))
             (when (at p11-11) (and (free-down) (free-left) (not (free-up)) (not (free-right))))
        )
    )
    ...
    (:action move-up
        ...
        :effect
            (and
                 ...
                 (when (at p11-1) (and (at p11-2) (not (at p11-1))))
                 (when (at p1-2) (and (at p1-3) (not (at p1-2))))
                 (when (at p11-2) (and (at p11-3) (not (at p11-2))))
                 (when (at p1-3) (and (at p1-4) (not (at p1-3))))
                 (when (at p11-3) (and (at p11-4) (not (at p11-3))))
                 (when (at p1-4) (and (at p1-5) (not (at p1-4))))
                 (when (at p11-4) (and (at p11-5) (not (at p11-4))))
                 (when (at p1-5) (and (at p1-6) (not (at p1-5))))
                 (when (at p11-5) (and (at p11-6) (not (at p11-5))))
                 (when (at p1-6) (and (at p1-7) (not (at p1-6))))
                 (when (at p11-6) (and (at p11-7) (not (at p11-6))))
                 (when (at p1-7) (and (at p1-8) (not (at p1-7))))
                 (when (at p11-7) (and (at p11-8) (not (at p11-7))))
                 (when (at p1-8) (and (at p1-9) (not (at p1-8))))
                 (when (at p11-8) (and (at p11-9) (not (at p11-8))))
                 (when (at p1-9) (and (at p1-10) (not (at p1-9))))
                 (when (at p11-9) (and (at p11-10) (not (at p11-9))))
                 (when (at p1-10) (and (at p1-11) (not (at p1-10))))
                 (when (at p11-10) (and (at p11-11) (not (at p11-10))))
            )
    )
    ...
    (:action move-down
        ...
        :effect
            (and
                 ...
                 (when (at p11-2) (and (at p11-1) (not (at p11-2))))
                 (when (at p1-3) (and (at p1-2) (not (at p1-3))))
                 (when (at p11-3) (and (at p11-2) (not (at p11-3))))
                 (when (at p1-4) (and (at p1-3) (not (at p1-4))))
                 (when (at p11-4) (and (at p11-3) (not (at p11-4))))
                 (when (at p1-5) (and (at p1-4) (not (at p1-5))))
                 (when (at p11-5) (and (at p11-4) (not (at p11-5))))
                 (when (at p1-6) (and (at p1-5) (not (at p1-6))))
                 (when (at p11-6) (and (at p11-5) (not (at p11-6))))
                 (when (at p1-7) (and (at p1-6) (not (at p1-7))))
                 (when (at p11-7) (and (at p11-6) (not (at p11-7))))
                 (when (at p1-8) (and (at p1-7) (not (at p1-8))))
                 (when (at p11-8) (and (at p11-7) (not (at p11-8))))
                 (when (at p1-9) (and (at p1-8) (not (at p1-9))))
                 (when (at p11-9) (and (at p11-8) (not (at p11-9))))
                 (when (at p1-10) (and (at p1-9) (not (at p1-10))))
                 (when (at p11-10) (and (at p11-9) (not (at p11-10))))
                 (when (at p1-11) (and (at p1-10) (not (at p1-11))))
                 (when (at p11-11) (and (at p11-10) (not (at p11-11))))
            )
    )
