...
(define (problem problem-5-5-12668)
    (:domain RockSample)
    (:objects
    ...
    (:init
        ...
        (invariant (not (good-rocks-in-range p1-4 h1)) (good r1) (good r3))
        ...
        (invariant (not (good-rocks-in-range p2-3 h1)) (good r1) (good r2) (good r3))
