...
(define (problem problem-5-5-28967)
    (:domain RockSample)
    (:objects
    ...
    (:init
        ...
        (invariant (not (good-rocks-in-range p0-4 h1)) (good r1) (good r2))
        (invariant (not (good-rocks-in-range p0-4 h2)) (good r1) (good r2) (good r3))
