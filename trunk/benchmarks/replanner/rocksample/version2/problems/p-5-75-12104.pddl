...
(define (problem problem-5-5-12104)
    (:domain RockSample)
    (:objects
    ...
    (:init
        ...
        (invariant (not (good-rocks-in-range p3-2 h1)) (good r0) (good r1) (good r2))
        ...
        (invariant (not (good-rocks-in-range p3-3 h1)) (good r1) (good r2) (good r3))
        ...
        (invariant (not (good-rocks-in-range p3-4 h2)) (good r1) (good r2) (good r3) (good r4))
        ...
        (invariant (not (good-rocks-in-range p4-2 h2)) (good r0) (good r1) (good r2))
        (invariant (not (good-rocks-in-range p4-3 h1)) (good r0) (good r2))
        (invariant (not (good-rocks-in-range p4-3 h2)) (good r0) (good r1) (good r2) (good r3))
