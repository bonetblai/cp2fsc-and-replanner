(define (domain logistics)
    ...
    (:predicates
        ...
        (obs-ol ?loc - LOCATION ?obj - OBJ)
        (obs-oa ?airport - AIRPORT ?obj - OBJ)
    )
    ...
    (:obs-variable (loc-obs ?loc - LOCATION ?obj - OBJ) (obs-ol ?loc ?obj))
    (:obs-variable (airport-obs ?airport - AIRPORT ?obj - OBJ) (obs-oa ?airport ?obj))

    (:action sense-loc-t
        :parameters (?truck - TRUCK ?loc - LOCATION)
        :precondition (at-tl ?truck ?loc)
        :sensing (forall (?o - OBJ)
                     (model-for (loc-obs ?loc ?o) (obs-ol ?loc ?o) (at-ol ?o ?loc))
                     ;(model-for (loc-obs ?loc ?o)
                     ;           (not (obs-ol ?loc ?o))
                     ;           (or (exists (?l - LOCATION) (and (not (= ?l ?loc)) (at-ol ?o ?l)))
                     ;               (exists (?a - AIRPORT) (at-oa ?o ?a))
                     ;               (exists (?t - TRUCK) (in-ot ?o ?t))
                     ;               (exists (?a - AIRPLANE) (in-oa ?o ?a)))
                     ;)
                     (model-for (loc-obs ?loc ?o) (not (obs-ol ?loc ?o)) (not (at-ol ?o ?loc)))
                 )
    )
    (:action sense-ap-t
        ...
        :sensing (forall (?o - OBJ)
                     (model-for (airport-obs ?airport ?o) (obs-oa ?airport ?o) (at-oa ?o ?airport))
                     ;(model-for (airport-obs ?airport ?o)
                     ;           (not (obs-oa ?airport ?o))
                     ;           (or (exists (?l - LOCATION) (at-ol ?o ?l))
                     ;               (exists (?a - AIRPORT) (and (not (= ?a ?airport)) (at-oa ?o ?a)))
                     ;               (exists (?t - TRUCK) (in-ot ?o ?t))
                     ;               (exists (?a - AIRPLANE) (in-oa ?o ?a)))
                     ;)
                     (model-for (airport-obs ?airport ?o) (not (obs-oa ?airport ?o)) (not (at-oa ?o ?airport)))
                 )
    )
    (:action sense-ap-a
    ...
    (:action FLY-AIRPLANE
        ...
        :sensing (forall (?o - OBJ)
                     (model-for (airport-obs ?airport2 ?o) (obs-oa ?airport2 ?o) (at-oa ?o ?airport2))
                     ;(model-for (airport-obs ?airport2 ?o)
                     ;           (not (obs-oa ?airport2 ?o))
                     ;           (or (exists (?l - LOCATION) (at-ol ?o ?l))
                     ;               (exists (?a - AIRPORT) (and (not (= ?a ?airport2)) (at-oa ?o ?a)))
                     ;               (exists (?t - TRUCK) (in-ot ?o ?t))
                     ;               (exists (?a - AIRPLANE) (in-oa ?o ?a)))
                     ;)
                     (model-for (airport-obs ?airport2 ?o) (not (obs-oa ?airport2 ?o)) (not (at-oa ?o ?airport2)))
                 )
    )
)
