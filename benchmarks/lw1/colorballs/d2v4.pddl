(define (domain colorballs) 
    ...
    (:action observe-color
        :parameters (?o - obj)
        :precondition (and (not (trashed ?o)) (holding ?o) (not (need-start)))
    ...
    (:action start-action
        ...
        :sensing
            (forall (?o - obj)
                ...
                ;           (not (obs-obj-at ?o ?p))
                ;           (or (holding ?o) (exists (?q - pos) (and (not (= ?p ?q)) (obj-at ?o ?q))))
                ;)
    ...
    (:action move
        ...
        :sensing
            (forall (?o - obj)
                ...
                ;           (not (obs-obj-at ?o ?j))
                ;           (or (holding ?o) (exists (?q - pos) (and (not (= ?j ?q)) (obj-at ?o ?q))))
                ;)
