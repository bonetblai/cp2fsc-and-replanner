(define (domain diagonal-wumpus-7x7) 
    ...
    ;(:var-group vgroup-1 wumpus-1)
    (:var-group vgroup-2 wumpus-1 wumpus-2)
    (:var-group vgroup-3 wumpus-2 wumpus-3)
    (:var-group vgroup-4 wumpus-3 wumpus-4)
    (:var-group vgroup-5 wumpus-4 wumpus-5)
    ;(:var-group vgroup-6 wumpus-5)
