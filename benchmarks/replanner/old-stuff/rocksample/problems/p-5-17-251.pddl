...
(define (problem problem-5-5-251)
    (:domain RockSample)
    (:objects
    ...
    (:init
        ...
        (invariant (not (good-rocks-in-range p4-0 h2)) (good r0) (good r1) (good r4))
        (invariant (not (good-rocks-in-range p4-1 h0)) (good r1))
        (invariant (not (good-rocks-in-range p4-1 h1)) (good r0) (good r1) (good r4))
