...
(define (problem bottleneck5)
    ...
    (:hidden
       ...
       (wumpus p16) (stench p17) (stench p26) (stench p15)
       (wumpus p25) (stench p26) (stench p24) (stench p15)
       (wumpus p63) (stench p64) (stench p73) (stench p53)
       (wumpus p64) (stench p65) (stench p74) (stench p63) (stench p54)
       (wumpus p66) (stench p76) (stench p65) (stench p56)
       (wumpus p73) (stench p74) (stench p63)
       (wumpus p74) (stench p75) (stench p73) (stench p64)
       (wumpus p75) (stench p76) (stench p74) (stench p65)
       (wumpus p86) (stench p96) (stench p76)
    )
    (:goal (at p27))
)
