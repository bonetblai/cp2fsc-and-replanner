...
(define (problem map-jair-dlrta)
    (:domain freespace)
    (:objects
        x1 x2 x3 x4 x5 x6 x7 x8 x9 x10 x11 x12 x13 x14 x15 x16 - xpos
        y1 y2 y3 y4 y5 y6 y7 y8 - ypos)
    (:init
        (suc-x x1 x2) (suc-x x2 x3) (suc-x x3 x4) (suc-x x4 x5) (suc-x x5 x6) (suc-x x6 x7) (suc-x x7 x8) (suc-x x8 x9) (suc-x x9 x10) (suc-x x10 x11) (suc-x x11 x12) (suc-x x12 x13) (suc-x x13 x14) (suc-x x14 x15) (suc-x x15 x16)
    ...
    (:hidden
       (wall x1 y3) (wall x2 y3) (wall x3 y3) (wall x4 y3) (wall x5 y3) (wall x6 y3)
       (wall x7 y3) (wall x8 y3) (wall x9 y3) (wall x10 y3) (wall x11 y3) (wall x12 y3)
       (wall x13 y2) (wall x13 y3) (wall x13 y4) (wall x13 y5) (wall x13 y6)    )
    (:goal (at x7 y8))
)
