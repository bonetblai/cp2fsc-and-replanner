(define (problem n5-b4)
    ...
    (:hidden (ball-at b1 p5 p5) (ball-at b2 p2 p1) (ball-at b3 p4 p2) (ball-at b4 p1 p3))
    (:goal (and (ball-in-bag b1) (ball-in-bag b2) (ball-in-bag b3) (ball-in-bag b4)))
)
