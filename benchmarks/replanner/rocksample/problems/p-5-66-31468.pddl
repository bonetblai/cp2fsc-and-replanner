...
(define (problem problem-5-5-31468)
    (:domain RockSample)
    (:objects
    ...
    (:init
        ...
        (invariant (not (good-rocks-in-range p4-1 h1)) (good r0) (good r1) (good r2))
        (invariant (not (good-rocks-in-range p4-1 h2)) (good r0) (good r1) (good r2) (good r4))
        (invariant (not (good-rocks-in-range p4-2 h0)) (good r2))
        (invariant (not (good-rocks-in-range p4-2 h1)) (good r0) (good r2) (good r4))
