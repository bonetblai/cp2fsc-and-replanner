...
(define (problem problem-5-5-18466)
    (:domain RockSample)
    (:objects
    ...
    (:init
        ...
        (invariant (not (good-rocks-in-range p0-2 h2)) (good r0) (good r3) (good r4))
        (invariant (not (good-rocks-in-range p0-3 h0)) (good r0))
        (invariant (not (good-rocks-in-range p0-3 h1)) (good r0) (good r3) (good r4))
        (invariant (not (good-rocks-in-range p0-3 h2)) (good r0) (good r3) (good r4))
        (invariant (not (good-rocks-in-range p0-4 h0)) (good r3))
        (invariant (not (good-rocks-in-range p0-4 h1)) (good r0) (good r3))
