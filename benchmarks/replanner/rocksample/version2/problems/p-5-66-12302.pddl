...
(define (problem problem-5-5-12302)
    (:domain RockSample)
    (:objects
    ...
    (:init
        ...
        (invariant (not (good-rocks-in-range p3-2 h1)) (good r0) (good r1) (good r4))
        ...
        (invariant (not (good-rocks-in-range p4-2 h2)) (good r0) (good r1) (good r4))
