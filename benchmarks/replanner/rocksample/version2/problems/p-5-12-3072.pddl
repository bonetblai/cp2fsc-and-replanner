...
(define (problem problem-5-5-3072)
    (:domain RockSample)
    (:objects
    ...
    (:init
        ...
        (invariant (not (good-rocks-in-range p2-3 h1)) (good r2) (good r3) (good r4))
        ...
        (invariant (not (good-rocks-in-range p3-1 h1)) (good r0) (good r1))
